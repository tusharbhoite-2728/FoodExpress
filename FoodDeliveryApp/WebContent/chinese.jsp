...
<body>
    ...
    <div class="sidebar">
        <h2>Menu</h2>
        <a href="AllDishes.jsp" >All Dishes</a>
        <a href="vegeterian.jsp">Vegetarian</a>
        <a href="nonveg.jsp">Non-Vegetarian</a>
        <a href="chinese.jsp">Chinese</a>
        <a href="beverages.jsp">Beverages</a>
        <a href="dessert.jsp">Desserts</a>
    </div>
        ...
        <div class="dish-grid">
            <%
                ...
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT * FROM dishes where category = ?");
            ...
            %>
                <div class="dish-card">
                    ...
                    <div class="dish-info">
                        ...
                        <h3> Rs <%= price %></h3>
                        <a href="orderForm.jsp?id=<%= rs.getInt("id") %>&vendor_id=<%= rs.getInt("vendor_id") %>">
                        Order Now
                        </a>
